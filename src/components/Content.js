...
export default function Content() {
  return (
    <div className="content-container">
       <div className="content-title">The Everyday Gym Calculator</div>
        <div className="content-title-content">Quick maths is hard, especially when the pre-workout kicks in. <strong>Bar Is Loaded</strong> takes the math out of the gym and displays exactly what you need for your next lift. It doesn't matter if it's in <strong>kilograms</strong> or <strong>pounds</strong>, we got you covered. </div>
      <div className="content-grid">
        <div className="content-image">
          <img src={image0} className="image one" />
          <img src={image2} className="image two" />
        </div>
        <h2>Customize. Calculate. Lift.</h2>
        <div className="content-subheader">No reds, all blues? Don't be blue! Change your <strong>inventory</strong> seamlessly. It's never been easier with <strong>Bar Is Loaded</strong>.</div>
      </div>
      <div className="content-grid column-length">
        <h2>Suggestions.</h2>
        <div className="content-subheader-2">A lift has stalled and you've tried everything. We've all been there. Here are some <strong>exercises</strong> to help break through.</div>
        <div className="content-image">
